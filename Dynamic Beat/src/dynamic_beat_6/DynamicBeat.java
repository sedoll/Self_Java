...
public class DynamicBeat extends JFrame {
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/song1.png")).getImage(); // 선택 이미지 지정
	
	private Image selectedImage = new ImageIcon(Main.class.getResource("../images/00.jpg")).getImage(); // 선택 이미지 지정
	...
	private ImageIcon leftButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/leftButtonEntered.png")); // 시작 버튼 마우스 오버
	private ImageIcon leftButtonBasicImage = new ImageIcon(Main.class.getResource("../images/leftButtonBasic.png")); // 시작 버튼 기본
	private ImageIcon rightButtonEnteredImage = new ImageIcon(Main.class.getResource("../images/rightButtonEntered.png")); // 종료 버튼 마우스 오버 
	private ImageIcon rightButtonBasicImage = new ImageIcon(Main.class.getResource("../images/rightButtonBasic.png")); // 종료 버튼 기본
	...
	private JButton leftButton = new JButton(leftButtonBasicImage); // 시작 버튼
	private JButton rightButton = new JButton(rightButtonBasicImage); // 종료 버튼
	...
	public DynamicBeat() {
		...
		leftButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				leftButton.setCursor(new Cursor(Cursor.HAND_CURSOR)); // 커서 클릭 모양
				Music buttonEnteredMusic = new Music("le.mp3", false);
				buttonEnteredMusic.start();
			}
			...
			public void mouseExited(MouseEvent e) {
				...
				leftButton.setCursor(new Cursor(Cursor.DEFAULT_CURSOR)); // 커서 기본 모양
			}
...
//				System.exit(0); // 시스템 종료
		...
		rightButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				rightButton.setCursor(new Cursor(Cursor.HAND_CURSOR)); // 커서 클릭 모양
				Music buttonEnteredMusic = new Music("le.mp3", false);
				buttonEnteredMusic.start();
			}
			...
			public void mouseExited(MouseEvent e) {
				...
				rightButton.setCursor(new Cursor(Cursor.DEFAULT_CURSOR)); // 커서 기본 모양
			}
