...
public class Trans {
	...
	public static boolean gramCheck(String s) {
		boolean leftParenCheck = ("(".equals(s.substring(0,1))) ? true : false;
		boolean rightParenCheck = (")".equals(s.substring(s.length()-1))) ? true : false;
		boolean echoCheck = s.contains("(echo ");
		boolean catCheck = s.contains("(cat ");
	...
	public static String translate(String s) {
		...
		else if(s.contains("cat") && s.contains(".txt")) {
			// 첫 번째 텍스트 파일 이름 찾기
